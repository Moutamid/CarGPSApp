...
public class notification_fragment extends Fragment {
    ...
    private void refresh() {
        if (isAdded()) {
            ...
            caddieProfileVPadapter.addFragment(new MyNotificationFragment(), "Notifications");
            caddieProfileVPadapter.addFragment(new MyMaintenanceNotificationFragment(), "Maintenance Notifications");
